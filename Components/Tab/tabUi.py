...
# Form implementation generated from reading ui file '.\tabUi.ui' in Desktop/Folder/parent/test_su/Terminal../ folder
#
...
class UiTabWidget(object):
    def setup_ui(self, tabWidget):
        ...
        self.retranslate_ui(tabWidget)
        QtCore.QMetaObject.connectSlotsByName(tabWidget)

    def retranslate_ui(self, tabWidget):
